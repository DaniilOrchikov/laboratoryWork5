...
public class TicketBuilder {
    ...
    public Ticket getTicket() {
        return new Ticket(name, new Coordinates(x, y), this.creationDate == null ? java.time.LocalDateTime.now() : creationDate, price, type, new Venue(name, venueCapacity, venueType, new Address(addressStreet, addressZipCode)));
    }
    ...
    public Ticket getTicket(Long id) {
        return new Ticket(id, name, new Coordinates(x, y), this.creationDate == null ? java.time.LocalDateTime.now() : creationDate, price, type, new Venue(id, name, venueCapacity, venueType, new Address(addressStreet, addressZipCode)));
    }
